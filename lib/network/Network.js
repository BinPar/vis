...
function Network(container, data, options) {
  ...
  this.body.modules["kamadaKawai"] = new KamadaKawai(this.body,150,0.05, 100);   // Layouting algorithm.
...
Network.prototype.setOptions = function (options) {
  if (options !== undefined) {
    ...
    //set max iterations to KamadaKawai module
    this.body.modules["kamadaKawai"].setOptions(options.kamadaKawai);
